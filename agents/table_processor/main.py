...
agent = TableAgent(csv_path,
                 max_debug_times=0,
                 # use_assistants_api=True,
                 client="gpt-3.5-turbo-1106", # "gpt-3.5-turbo-1106", "gpt-4-1106-preview", "gpt-3.5-turbo-instruct", "gpt-3.5-turbo-0125"
                 head_number=2,
...
query = "can you please be so kind and filter out the countries with gdp less than 4380756541439"
...
result, details_dict = agent.answer_query(query, show_plot=False, save_plot_path="plots/kek2.png", check_plan=True)
